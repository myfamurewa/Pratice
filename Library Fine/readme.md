Your local library needs your help! Given the expected and actual return date for a library book, create a program that calculate the fine(if any). The fee structure is a follows:
